(custom-set-variables
 ...
 '(elpy-rpc-python-command "/Users/changfeng/anaconda3/envs/venv-py36/bin/python3")
 '(evil-want-Y-yank-to-eol nil)
 '(exec-path
   (quote
    ("/Users/changfeng/anaconda3/envs/venv-py36/bin" "/Library/Frameworks/Python.framework/Versions/2.7/bin" "/Library/Frameworks/Python.framework/Versions/3.6/bin" "/usr/local/bin" "/usr/bin" "/bin" "/usr/sbin" "/sbin" "/opt/X11/bin" "/usr/local/aria2/bin" "/usr/local/go/bin" "/Library/TeX/texbin" "/Applications/Wireshark.app/Contents/MacOS" "/Users/changfeng/.cask/bin" "/usr/local/texlive/2019/bin/x86_64-darwin" "/Users/changfeng/.local/bin" "/Library/Frameworks/Python.framework/Versions/3.7/bin")))
